...
for PROJ in  "remix"  ; do
  pnpm  --filter @react-params/test-$PROJ update @react-params/core@latest @react-params/react-router-dom@latest @react-params/remix@latest @react-params/react-router@latest
